...
class Admin::EditionFilterTest < ActiveSupport::TestCase
  ...
  test "should filter by news article category" do
    news_story_document_type = build_configurable_document_type("news_story", { "settings" => { "publishing_api_schema_name" => "news_article" } })
    press_release_document_type = build_configurable_document_type("press_release", { "settings" => { "publishing_api_schema_name" => "news_article" } })
