...
ActiveRecord::Schema.define(version: 2021_03_02_160246) do
  ...
  create_table "social_media_account_translations", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
